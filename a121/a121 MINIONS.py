...
def minion_WIN():
    minionWIMG = "minions_happy.gif"
    wn.addshape(minionWIMG)
    minionW = trtl.Turtle()
    minionW.shape(minionWIMG)
    minionW.penup()
    minionW.goto(0, -160)
    
def minion_LOSS():
    minionLIMG = "minions_laughing.gif"
    wn.addshape(minionLIMG)
    minionW = trtl.Turtle()
    minionW.shape(minionLIMG)
    minionW.penup()
    minionW.goto(0, -160)
